...
function createBarChart(data, maxWidth = 50) {
    ...
    entries.forEach(([key, value]) => {
        ...
        chart += `${key.padStart(3)} sites │${bar} ${value}\n`;
    });
...
function generateMarkdown(analysisResults) {
    ...
    const markdown = `# 📊 Logo Grouping Statistics
...
*Generated by Logo Grouping Engine • ${new Date().toLocaleString()}*
`;
...
function generateAndSaveStats(groups, totalSites) {
    ...
    console.log('✅ JSON statistics saved to stats.json');
